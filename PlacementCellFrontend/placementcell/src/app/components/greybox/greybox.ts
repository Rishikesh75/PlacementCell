...
import {DSAQuestionType} from '../../models/feedbackcard.model';
import {CoreCSquestionType} from '../../models/feedbackcard.model';
import {ResourceCategory} from '../../models/feedbackcard.model';
@Component({
